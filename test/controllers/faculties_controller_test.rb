...
class FacultiesControllerTest < ActionController::TestCase
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post :create, faculty: { address: @faculty.address, college_id: @faculty.college_id, email: @faculty.email, name: @faculty.name, password: 'secret', password_confirmation: 'secret' }
    end
  ...
  test "should update faculty" do
    patch :update, id: @faculty, faculty: { address: @faculty.address, college_id: @faculty.college_id, email: @faculty.email, name: @faculty.name, password: 'secret', password_confirmation: 'secret' }
    assert_redirected_to faculty_path(assigns(:faculty))
  end
