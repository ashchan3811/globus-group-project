class SubjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @subject.save
        format.html { redirect_to new_subject_path, :flash => {:success => 'Subject was successfully created.' } }
  ...
  private
    ...
    def subject_params
      params.require(:subject).permit(:name, :code, :semester_id, :syllabus_id , :branch_id , :subject_type_id)
    end
end
